--------------------------------------------------------
--  File created - wtorek-kwiecieñ-30-2013   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Sequence ENTRIES_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "DASHBOARD"."ENTRIES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 43 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into DASHBOARD.PROJECTS (PROJECT_ID,NAME,HOURS_PER_WEEK,TOTAL_HOURS,PRIORITY,START_DATE,OWNER_ID) values ('2','Certyfikat-eng','5','90','c',to_date('13/03/28','RR/MM/DD'),'1');
Insert into DASHBOARD.PROJECTS (PROJECT_ID,NAME,HOURS_PER_WEEK,TOTAL_HOURS,PRIORITY,START_DATE,OWNER_ID) values ('3','Hiszpanski','4','480','c',to_date('13/03/28','RR/MM/DD'),'1');
Insert into DASHBOARD.PROJECTS (PROJECT_ID,NAME,HOURS_PER_WEEK,TOTAL_HOURS,PRIORITY,START_DATE,OWNER_ID) values ('4','Dyplom','15','666','a',to_date('13/04/11','RR/MM/DD'),'1');
Insert into DASHBOARD.PROJECTS (PROJECT_ID,NAME,HOURS_PER_WEEK,TOTAL_HOURS,PRIORITY,START_DATE,OWNER_ID) values ('5','Miasto','1','50','c',to_date('13/04/11','RR/MM/DD'),'1');
Insert into DASHBOARD.PROJECTS (PROJECT_ID,NAME,HOURS_PER_WEEK,TOTAL_HOURS,PRIORITY,START_DATE,OWNER_ID) values ('6','Dashboard','4','50','b',to_date('13/04/01','RR/MM/DD'),'1');
Insert into DASHBOARD.PROJECTS (PROJECT_ID,NAME,HOURS_PER_WEEK,TOTAL_HOURS,PRIORITY,START_DATE,OWNER_ID) values ('7','Ksiazki','4','666','b',to_date('13/04/19','RR/MM/DD'),'1');
Insert into DASHBOARD.PROJECTS (PROJECT_ID,NAME,HOURS_PER_WEEK,TOTAL_HOURS,PRIORITY,START_DATE,OWNER_ID) values ('8','Motoryzacja','2','666','b',to_date('13/04/22','RR/MM/DD'),'1');
Insert into DASHBOARD.PROJECTS (PROJECT_ID,NAME,HOURS_PER_WEEK,TOTAL_HOURS,PRIORITY,START_DATE,OWNER_ID) values ('9','Firma','2','666','b',to_date('13/04/22','RR/MM/DD'),'1');
