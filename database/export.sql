--------------------------------------------------------
--  File created - sobota-maj-11-2013   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Sequence ENTRIES_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "DASHBOARD"."ENTRIES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 55 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into DASHBOARD.ENTRIES (ENTRY_ID,PROJECT_ID,AMOUNT,ENTRY_DATE,OWNER_ID) values ('49','1','10',to_date('13/05/06','RR/MM/DD'),'1');
Insert into DASHBOARD.ENTRIES (ENTRY_ID,PROJECT_ID,AMOUNT,ENTRY_DATE,OWNER_ID) values ('50','1','1',to_date('13/05/07','RR/MM/DD'),'1');
Insert into DASHBOARD.ENTRIES (ENTRY_ID,PROJECT_ID,AMOUNT,ENTRY_DATE,OWNER_ID) values ('51','4','8',to_date('13/05/07','RR/MM/DD'),'1');
Insert into DASHBOARD.ENTRIES (ENTRY_ID,PROJECT_ID,AMOUNT,ENTRY_DATE,OWNER_ID) values ('52','4','3',to_date('13/05/08','RR/MM/DD'),'1');
Insert into DASHBOARD.ENTRIES (ENTRY_ID,PROJECT_ID,AMOUNT,ENTRY_DATE,OWNER_ID) values ('53','1','2',to_date('13/05/08','RR/MM/DD'),'1');
Insert into DASHBOARD.ENTRIES (ENTRY_ID,PROJECT_ID,AMOUNT,ENTRY_DATE,OWNER_ID) values ('54','1','3',to_date('13/05/09','RR/MM/DD'),'1');
